...
let obtenerDato = document.getElementsByTagName("tr");
const c = document.getElementById("miItemActual")
let elementosFila = obtenerDato.getElementsByTagName('td');
console.log(obtenerDato);
console.log(c.elementosFila)
